...
Install-Repo httpx https://github.com/projectdiscovery/httpx.git
...
Install-Repo nikto https://github.com/sullo/nikto.git
Install-Repo sqlmap https://github.com/sqlmapproject/sqlmap.git
Install-Repo ffuf https://github.com/ffuf/ffuf.git
Install-Repo hydra https://github.com/vanhauser-thc/thc-hydra.git

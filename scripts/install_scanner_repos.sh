...
install_repo httpx https://github.com/projectdiscovery/httpx.git
...
install_repo nikto https://github.com/sullo/nikto.git
install_repo sqlmap https://github.com/sqlmapproject/sqlmap.git
install_repo ffuf https://github.com/ffuf/ffuf.git
install_repo hydra https://github.com/vanhauser-thc/thc-hydra.git
install_repo mythic https://github.com/its-a-feature/Mythic.git
install_repo sliver https://github.com/BishopFox/sliver.git
install_repo empire https://github.com/BC-SECURITY/Empire.git
install_repo covenant https://github.com/cobbr/Covenant.git
